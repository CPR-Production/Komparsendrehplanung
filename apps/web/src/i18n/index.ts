...
const resources = {
  de: {
    translation: {
      ...
      "settings.color.intro":
        "Eine Szene wird nach ihrem Zustand eingefärbt — Int oder Ex, zusammen mit der Tageszeit. Hintergrund und Text lassen sich getrennt einstellen. Was hier nicht geändert wird, folgt weiter der Vorgabe.",
      "settings.color.background": "Hintergrund",
      "settings.color.text": "Text",
      "settings.color.reset": "Diesen Zustand auf die Vorgabe zurücksetzen",
      ...
      "sceneState.intExt.intern": "Int",
      "sceneState.intExt.extern": "Ex",
  ...
  en: {
    translation: {
      ...
      "settings.color.intro":
        "A scene is coloured by its state — Int or Ext, together with the time of day. Background and text are set separately. Anything left alone here keeps following the default.",
      "settings.color.background": "Background",
      "settings.color.text": "Text",
      "settings.color.reset": "Reset this state to the default",
